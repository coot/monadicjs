...
/**
 * Either type.  Do not construct instances using `new Either()`.  Use `Right`
 * and `Left` constructors.  If you want to subclass just use prototype
 * inhertiance directly.
 */
...
/**
 * Right constructor.  You can check if an object is instance of Right simply
 * by `o instanceof Right`.  `o instanceof Either` will return true as well.
 * @param {any} value
 * @return {Right}
 */
...
/**
 * Left contructor.  You can check if an object is instance of Right simply by
 * `o instance Left`, `o instance Left` will return true as well.
 */
function Left(value) {
  return {
